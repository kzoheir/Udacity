      ...
      if (s != "") {
        ...
        if (event == "telemetry") {
          ...
          */
          ...
          // Fits a 3rd-order polynomial to the waypoints (w.r.t car)
          ...
          // x, y and psi are all  = 0 as they are w.r.t car frame not map frame
          ...
          // Steering is normalized to  be within [-1, 1].
