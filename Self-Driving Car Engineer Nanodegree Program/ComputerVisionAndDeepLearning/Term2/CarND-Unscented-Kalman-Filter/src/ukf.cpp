...
UKF::UKF() {
 ...
 //Set augmented state dimension
  ...
  std_a_ = 3; // 2m/s Seems to be the proper value at startup (from 0) and typically 0.25: https://www.analyticcycling.com/DiffEqMotionFunctions_Page.html // 30: Initial value to be tuned.
  // Testing with std_a and std_yawdd_ however, give a better performance for std_a_ = 4. Higher value (5) would give a better performance when starting from 0m/s. But it's not typical. 

  // Process noise standard deviation yaw acceleration in rad/s^2
  std_yawdd_ = 0.35; // 0.25 Seems to be the proper value: http://dynamicsystems.asmedigitalcollection.asme.org/data/journals/jdsmaa/934451/ds_137_12_121005_f009.png from http://dynamicsystems.asmedigitalcollection.asme.org/article.aspx?articleid=2436201. Note: ALthough these are about EV but with manual yaw rate (i.e.: No power sterring, etc. This is the closest site I could find) // Initial value to be tuned
